...
(2, '2021_06_01_172545_create_users_table', 1),
(3, '2021_06_01_172609_create_user_roles_table', 1),
(4, '2021_06_20_120021_create_quizzes_table', 1),
(5, '2021_06_20_120035_create_questions_table', 1),
(6, '2021_06_20_120057_create_results_table', 1),
(7, '2021_06_20_235515_create_exam_candidates_table', 1),
(8, '2024_11_04_202202_add_details_to_users_table', 1);
...
--
ALTER TABLE `exam_candidates`
  ADD CONSTRAINT `exam_candidates_quiz_id_foreign` FOREIGN KEY (`quiz_id`) REFERENCES `quizzes` (`id`) ON DELETE CASCADE,
